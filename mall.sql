create table `mall_user`(
  ...
  `sort_order` int(4) DEFAULT NULL COMMENT '排序编号，同类展示顺序，数值等自然排序',
...
create table `mall_product`(
	...
	`sub_images` text COMMENT '图片资质，json格式，扩展用',
...
create table `mall_pay_info`(
	...
	`platform_number` varchar(200) DEFAULT NULL COMMENT '支付宝支付,支付平台给的订单号',
